...
function ThemeToggler({
  ...
  const toggleTheme = React.useCallback(
    async (theme: ThemeSelection) => {
      ...
      // Persiste imediatamente — provider customizado já aplica .dark / .light
      // via effect. Não dependemos do .finally() da animação para isso.
      setTheme(theme);
      ...
      // Animação visual apenas — tema já está persistido.
